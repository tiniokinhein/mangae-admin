...
import { GROCERY, GROCERY_FETCH, GROCERY_UPLOAD, G_CATEGORY, G_WEIGHT } from '../../config/api'
...
const EditGrocery = (props) => {
    ...
    const getItem = React.useCallback(() => {
        ...
        .on('value', (snap) => {
            ...
            if(!_isMounted.current) {
                setP(data)
                setTitleMon(data ? data.title_mon : '')
                setTitleMM(data ? data.title_mm : '')
                setImage(data ? data.image : '')
                setDescriptionMon(data ? data.description_mon : '')
                setDescriptionMM(data ? data.description_mm : '')
                setOriginalPrice(data ? data.originalPrice : '')
                setDiscountOrPromotion(data ? data.discountOrPromotion : '')
    ...
    const updateOnSubmit = e => {
        ...
        if(categories !== (p ? p.categories : null)) {
                    ...
                    <div className="col-6">
                        <div className="form-group">
                            <label 
                                ...
                                className="form-label text-light font-normal"
                            >
                                Unit {unit.title_mm && <>({unit.title_mm})</>}
                            </label>
                            <select
                                name="unit"
                                id="unit"
            ...
            <div className="col-12 col-md-6 mb-4">
                <div className="form-group">
                    <label 
                        ...
                        className="form-label text-light font-normal"
                    >
                        Categories {categories.map(c => c.title_mm && <span key={c.id}>| {c.title_mm} </span>)}
                    </label>
                    <select
                        name="categories"
                        id="categories"
...
export default withRouter(EditGrocery)
